...
@interface StartupLoadingObject : KrollCoverageObject {
#else
@interface StartupLoadingObject : KrollObject {
#endif
@private
...
extern NSString * StartupLoading$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StartupLoadingObject *_startuploading;
	BOOL shutdown;
