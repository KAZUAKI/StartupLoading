...
//@interface StartupLoadingObject : NSObject
//@end

@interface StartupLoadingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StartupLoadingObject class]])
		{
			for (NSString *key in [[(StartupLoadingObject*)o modules] allKeys])
			{
