...
/**
 The base class for all StartupLoading modules
 */
...
/**
 StartupLoading Platform calls this method on startup.
 */
-(void)startup;

/**
 StartupLoading Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 StartupLoading Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 StartupLoading Platform calls this method on resume.
 @param sender The sender of the event.
 */
