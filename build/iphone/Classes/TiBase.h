...
// in simulator we redefine to format for StartupLoading Developer console
...
{\
	NSString * exceptionName = [@"org.startuploading." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.startuploading";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIStartupLoadingNativeItemNone = -1, 
	UIStartupLoadingNativeItemSpinner = -2,
	UIStartupLoadingNativeItemProgressBar = -3,
	
	UIStartupLoadingNativeItemSlider = -4,
	UIStartupLoadingNativeItemSwitch = -5,
	UIStartupLoadingNativeItemMultiButton = -6,
	UIStartupLoadingNativeItemSegmented = -7,
	
	UIStartupLoadingNativeItemTextView = -8,
	UIStartupLoadingNativeItemTextField = -9,
	UIStartupLoadingNativeItemSearchBar = -10,
	
	UIStartupLoadingNativeItemPicker = -11,
	UIStartupLoadingNativeItemDatePicker = -12,
	
	UIStartupLoadingNativeItemInfoLight = -13,
	UIStartupLoadingNativeItemInfoDark = -14,
	
	UIStartupLoadingNativeItemDisclosure = -15,
	
	UIStartupLoadingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StartupLoading instances of
